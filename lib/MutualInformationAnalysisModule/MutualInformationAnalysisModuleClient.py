...
class MutualInformationAnalysisModule(object):
    ...
    def run_flux_mutual_information_analysis(self, params, context=None):
        ...
        return self._client.call_method(
            'MutualInformationAnalysisModule.run_flux_mutual_information_analysis',
            [params], self._service_ver, context)

    def status(self, context=None):
        return self._client.call_method('MutualInformationAnalysisModule.status',
