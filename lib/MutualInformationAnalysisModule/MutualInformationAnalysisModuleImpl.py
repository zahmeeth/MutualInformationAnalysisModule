...
class MutualInformationAnalysisModule:
    ...
    def run_flux_mutual_information_analysis(self, ctx, params):
        ...
        media_id_list, media_matrix, uuid = MI_runner._make_media_files(workspace_name, media_id, compounds)
        [biomass_path,secretion_path,flux_path,full_secretion_path,full_flux_path] = MI_runner._run_fba(workspace_name, media_id_list, fbamodel_id, uuid)
